    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <?php if ($sessionUser['type'] == 1) { // Access added by krishh ?>
            <li class="dropdown" id="topNavUsers">
              <a href="<?php echo base_url('users') ?>"> <i class="glyphicon glyphicon-user"></i> Users </a>
            </li>
          <?php } ?>
          <?php if ($sessionUser['type'] == 1 || $sessionUser['type'] == 3) { // Access added by krishh ?>
          ...
          <?php } ?>
          <?php
          if ($sessionUser['type'] == 1 || $sessionUser['type'] == 3) { // Access added by krishh
          ?>
          ...
          ?>
          <?php
          if ($sessionUser['type'] == 1) { // Access added by krishh
          ?>
          ...
          ?>
          <?php
          if ($sessionUser['type'] == 1 || $sessionUser['type'] == 2) { // Access added by krishh
          ?>
