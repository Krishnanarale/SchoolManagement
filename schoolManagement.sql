...
--
-- Host: localhost
-- Generation Time: Jun 30, 2020 at 08:00 AM
...
(1, 2, 0, 1, 0, 0, '2020-06-22', 1),
(2, 1, 1, 0, 1, 1, '2020-06-22', 1);
...
(1, '2020-06-22', 'Note books', '1500.00');
...
(1, 'Mid term', '2020-06-01', '2020-06-30', '5000', 1);
...
(1, '2020-06-18', 1, 1, 'Bhushan', 'B', 'assets/images/default/default_avatar.png', '30', '2020-06-22', '8888888888', 'bhushan@mail.com', 'Pune', 'Pune', '');
...
(1, '2020-06-22', 'Krishna', 'N', 'assets/images/default/default_avatar.png', '2020-06-22', '25', '9175077149', 'krishna@mail.com', 'Pune', 'Pune', 'India', 1);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin', 'A', 'admin@mail.com');
...
--
ALTER TABLE `marksheet_student`
  MODIFY `marksheet_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
